...
public class Utility {
    ...
    /**
     *  解析和处理服务器返回的省级数据
     *  注意到服务器返回的数据是： “代号|城市，代号|城市”这种格式
     *  所以可以分别按照“，”和“|”来分割和提取数据
     *  然后再调用CoolWeatherDB的三个save()方法将数据存储到相应的表中
     */
     ...
     */
    public static void handleWeatherResponce(Context context, String responce){
        try {//weatherinfo,city,cityid...是服务器返回的信息里的键值对
    ...
    private static void saveWeatherInfo(Context context, String cityName, String weatherCode,
        ...
        //SharedPreferences是安卓上一个轻量级的存储类，主要是保存一些常用的配置
