...
import com.example.wwh.coolweather.app.db.CoolWeatherOpenHelper;
...
public class CoolWeatherDB {
    ...
    /**
     *  CoolWeatherDB是一个单例类，我们将它的构造方法私有化
     *  并提供getInstance()方法来获取它的实例，这样子就
    ...
    public List<County> loadCounties(int cityId){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                county.setId(cursor.getInt(
                        cursor.getColumnIndex("id")));
                county.setConutyName(cursor.getString(
